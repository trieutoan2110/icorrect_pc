...
class LoginPresenter {
  ...
  Future<void> loginWithClassID(BuildContext context, String username, String classID) async{
    ...
    _repository!.loginWithClassID(username, classID, licenseKey!, merchantID!).then((value) async {
